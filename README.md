...
На чем остановилась: установила venv в докерфайле
TODO: устанавливать все зависимости в докерфайле чтобы в пайплайне можно было сразу запускать проект

Дополнительно через UI Jenkins устанавливаем Docker и Docker Pipeline плагины (помимо рекомендуемых), чтобы запускать приложение через компоуз